    ...
    <div class="pa-lg">
      ...
      <a class="block" routerLink="/playgrounds/new">
        <button class="w-100p bg-primary pa-md pv-sm ma-0 color-neutral-lighter b dim-and-grow" type="button">
          <img src="assets/ui-icon-diamond-plus.svg" alt="" class="inline-block va-middle" />
          {{i18n.create}}
        </button>
      </a>
...
export class IntroComponent {
  i18n = {
    ...
    p2: `
      Тук можеш да дадеш своя принос към каузата като добавиш игрището в квартала или училищния двор.
      Така ще ни помогнеш да съберем на едно място всички игрища и разберем от какво се нуждаят, за да привличат повече хора като нас.
    `,
    create: 'Ново игрище',
